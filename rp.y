...
%token NUM ADD LW SW BEQ NOP ADDFP COMA AC CC
%%
input:    /* empty */
| input line
;
...
instruction: ADD NUM COMA NUM COMA NUM  { add_to_bin(0, $2.n, $4.n, $6.n);}
			...
			| LW NUM COMA NUM AC NUM CC  { fmt.Println($2.n, $4.n, $6.n); LW_SW_to_bin(1, $2.n, $4.n, $6.n);}
			| BEQ NUM COMA NUM COMA NUM { fmt.Println($2.n, $4.n, $6.n); beq_to_bin($2.n, $4.n, $6.n);}
			| NOP
			;
